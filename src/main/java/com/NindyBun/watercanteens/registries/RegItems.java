...
public class RegItems {
    ...
    public static final DeferredHolder<Item, FilledCanteen> FILLED_COPPER_CANTEEN = ITEMS.register("filled-copper-canteen",
            () -> new FilledCanteen(CanteenTiers.COPPER).setEmptyCanteen(EMPTY_COPPER_CANTEEN.get()));
